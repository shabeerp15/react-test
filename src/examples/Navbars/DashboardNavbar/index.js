...
function DashboardNavbar({ absolute, light, isMini }) {
  ...
  const renderMenuProfile = () => (
    <Menu
      ...
      sx={{ mt: 2 }}
    >
      <ProfileItem icon={<Icon>login</Icon>} title="Shabeer" />
      <ProfileItem icon={<Icon>logout</Icon>} title="Logout" onClick={logoutHandler}/>
    </Menu>
  );
          ...
          <MDBox sx={(theme) => navbarRow(theme, { isMini })}>
            ...
            <MDBox color={light ? "white" : "inherit"}>
              ...
              {/* <Link to="/authentication/sign-in/basic">
                ...
                <IconButton sx={navbarIconButton} size="small" disableRipple onClick={handleOpenMenuProfile}>
                  <Icon sx={iconsStyle}>account_circle</Icon>
                </IconButton>
